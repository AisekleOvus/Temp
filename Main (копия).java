...
System.out.println("appendableObjectWriting : "+((Block) object).getId());
...
/*        this.minerId = minerId;
        ...
        this.difficulty = creationTime == 15
                          ? difficulty : creationTime < 15
                          ? difficulty+1 : difficulty > 0
                          ? difficulty-1 : difficulty;
        difficultyChange = difficultyOld < difficulty ? "was increased to" + difficulty
                           : difficultyOld == difficulty ? "stays the same"
                           : difficultyOld > difficulty ? "was decreased by 1" : "";
...
//        if(lastBlock.getId()+2 == offeredBlock.getId()) {
...
//        this.newBlockId = lastBlock.getId()+2;
